...
public class Color
{
	...
	{
		red = Utils.limit((c.red + this.red) / 2, 0, 255);
		green = Utils.limit((c.green + this.green) / 2, 0, 255);
		blue = Utils.limit((c.blue + this.blue) / 2, 0, 255);
	...
	{
		GL11.glColor4d(this.red / 255d, this.green / 255d, this.blue / 255d, this.alpha / 255d);
	}
	...
	public static final Color Cyan = new Color(0, 220, 255, "s");
