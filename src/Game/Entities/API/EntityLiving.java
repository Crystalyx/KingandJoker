...
public class EntityLiving extends Entity
{
	...
	public double energy = 180;
	public double maxenergy = 180;
	...
	public EntityLiving(Vec2 pos, double width, double height, Icon sprite)
	{
	...
	public void update(long time)
	{
		...
		this.maxenergy = this.modifiers.countValue(SharedModifiers.Energy);
